...
function generateComponentExamples(component) {
  // Special case for button-label component
  if (component.tagName === 'm-button-label') {
    return `
      <section>
        <h3>Usage</h3>
        <p>Use <code>&lt;m-button-label&gt;</code> inside a button to organize icon and text layout:</p>
